...
public class LoaderActivity extends BaseActivity {
    ...
    private final String BASE_URL = "http://test.shaverna.com/vpngate.php";
    private final String BASE_FILE_NAME = "vpngate.csv";

    private boolean premiumStage = true;

    private final String PREMIUM_URL = "http://test.shaverna.com/vpngate.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(jap.mizuki.vpn.R.layout.activity_loader);
        android.support.v7.app.ActionBar actionBar = getSupportActionBar();
        actionBar.hide();
        progressBar = (NumberProgressBar) findViewById(jap.mizuki.vpn.R.id.number_progress_bar);
        commentsText = (TextView) findViewById(jap.mizuki.vpn.R.id.commentsText);
        ...
        if (getIntent().getBooleanExtra("firstPremiumLoad", false))
            ((TextView) findViewById(jap.mizuki.vpn.R.id.loaderPremiumText)).setVisibility(View.VISIBLE);
            ...
            public boolean handleMessage(Message msg) {
                switch (msg.arg1) {
                    ...
                    case DOWNLOAD_PROGRESS: {
                        commentsText.setText(jap.mizuki.vpn.R.string.downloading_csv_text);
                        progressBar.setProgress(msg.arg2);

                    }
                    break;
                    case PARSE_PROGRESS: {
                        commentsText.setText(jap.mizuki.vpn.R.string.parsing_csv_text);
                        progressBar.setProgress(msg.arg2);
                    }
                    break;
                    case LOADING_SUCCESS: {
                        commentsText.setText(jap.mizuki.vpn.R.string.successfully_loaded);
                        progressBar.setProgress(100);
        ...
        AndroidNetworking.download(url, getCacheDir().getPath(), fileName)
                ...
                .startDownload(new DownloadListener() {
                    ...
                    public void onError(ANError error) {
                        Message msg = new Message();
                        msg.arg1 = LOAD_ERROR;
                        msg.arg2 = jap.mizuki.vpn.R.string.network_error;
                        updateHandler.sendMessage(msg);
                    }
                });
    }
    ...
    private void parseCSVFile(String fileName) {
        ...
        try {
            ...
            Message msg = new Message();
            msg.arg1 = LOAD_ERROR;
            msg.arg2 = jap.mizuki.vpn.R.string.csv_file_error;
            updateHandler.sendMessage(msg);
        }
        if (reader != null) {
            try {
                ...
                Message msg = new Message();
                msg.arg1 = LOAD_ERROR;
                msg.arg2 = jap.mizuki.vpn.R.string.csv_file_error_parsing;
                updateHandler.sendMessage(msg);
            }
        }
    }
