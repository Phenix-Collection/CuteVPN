...
import jap.mizuki.vpn.SpeedTest;
import jap.mizuki.vpn.model.Country;
import jap.mizuki.vpn.model.Server;
import jap.mizuki.vpn.util.BitmapGenerator;

import jap.mizuki.vpn.util.ConnectionQuality;
import jap.mizuki.vpn.util.LoadData;
import jap.mizuki.vpn.util.PropertiesService;
import jap.mizuki.vpn.util.map.MapCreator;
import jap.mizuki.vpn.util.map.MyMarker;
...
public class HomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-2803536266877113~9951946522");


        mInterstitialAd = new InterstitialAd(this);
        mInterstitialAd.setAdUnitId("ca-app-pub-2803536266877113/9134502889");
